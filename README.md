...
- [Taskosaur](https://taskosaur.com/) - Project management platform with AI assistant integration that allows task management through natural language commands and browser automation. ([Source Code](https://github.com/Taskosaur/Taskosaur)) `BSL-1.1` `Nodejs/Docker`
...
- [Kuvasz Uptime](https://kuvasz-uptime.dev) - Performant, stable uptime & SSL monitoring service that just works. ([Source Code](https://github.com/kuvasz-uptime/kuvasz)) `Apache-2.0` `Docker`
